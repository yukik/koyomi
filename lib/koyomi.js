 ...
 *   [method]
 *     {String} format ({Date|String} date, {String} format, {Number} eigyobi, {Boolean} include)
 */
 ...
 *     {Number}      monthEigyobi ({Date|String|Number} date/year, {Number} month)
 *     {Number}      nendoEigyoubi ({Date|String} date)
 ...
 *     {Boolean} checkDayInfoHoliday ({Date|String} date)
 ...
 *     {Number} nendoDays ({Date|String})
 *     {Number} passNendoDays ({Date|String})
 *     {Number} remainNendoDays ({Date|String})
...
// {Date} toDate({Date|String|Array} date, {Boolean} trim, {Boolean} clone)
Koyomi.toDate = require('./fx/toDate');

// {Number|Array} getWeekIndex ({String|Array|Number} week, {Number|Array} defaultValue)
